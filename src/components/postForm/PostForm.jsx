...
function PostForm({ post }){
    ...
    const { register, handleSubmit, watch,setValue,control,getValues
        ...
        React.useEffect(() => { 
            ...
            // the return statement is used for the memory management and the optimization 
            // with the help of unsubcribe the useEffect not runs again and again it only runs for single time.
